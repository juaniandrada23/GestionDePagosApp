  ...
  return (
    <PageLayout>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
            ...
            <FormField label="Proveedor">
              <select
                ...
                onChange={(e) => setNombreProveedorFiltro(e.target.value)}
          ...
          <Grid item xs={12} lg={4}>
            ...
            >
              <form className="space-y-4 pt-4" onSubmit={handleFormSubmit}>
                <FormField label="Proveedor / Cliente" error={formErrors.nombre}>
                  <select
                    name="_entidad"
                    value={entidadValue}
                  ...
                  {isLoadingSkeleton ? (
                    ...
                    <tr>
                      <td colSpan={colCount} className="px-4 py-16 text-center">
                        <EmptyState
                          ...
                          subtitle="Agrega una nueva compra o ajusta los filtros"
                        />
                      </td>
                    </tr>
                  ) : (
                    paginatedPagos.map((pago) => (
                      <tr key={pago.idPago} className="hover:bg-gray-50/60 transition-colors">
                        ...
                        <td className="px-4 py-3 text-sm text-right font-semibold whitespace-nowrap text-red-600">
                          {formatMonto(pago.monto)}
                        </td>
                        <td className="px-4 py-3 text-sm text-right font-medium whitespace-nowrap text-red-600">
      ...
      <FormDialog
        ...
        title="Editar compra"
        subtitle={`Modificar los datos de la compra #${editPago?.idPago}`}
        onSubmit={handleEditSubmit}
        isLoading={editLoading}
        maxWidth="480px"
      >
        <FormField label="Proveedor / Cliente" error={editFormErrors.nombre}>
          <select
            name="_entidad"
